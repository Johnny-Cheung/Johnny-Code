...
func TestBuildExtractAutoOnlyPromptMarkers(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(7, "", false, "/home/test/.johnnycode/memory/", "/tmp/proj/.johnnycode/memory/")
...
func TestBuildExtractAutoOnlyPromptSkipIndex(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(5, "", true, "/home/test/.johnnycode/memory/", "/tmp/proj/.johnnycode/memory/")
...
func TestBuildExtractAutoOnlyPromptIncludesExistingManifest(t *testing.T) {
	...
	got := BuildExtractAutoOnlyPrompt(3, manifest, false, "/home/test/.johnnycode/memory/", "/tmp/proj/.johnnycode/memory/")
...
func TestBuildExtractAutoOnlyPromptNoTeamSection(t *testing.T) {
	...
	// must still never appear — Johnny Code keeps the user/project split simple.
	got := BuildExtractAutoOnlyPrompt(3, "", false, "/home/test/.johnnycode/memory/", "/tmp/proj/.johnnycode/memory/")
