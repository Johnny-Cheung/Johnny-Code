...
func TestLoadInstructionsBasic(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "JOHNNYCODE.md"), "root johnnycode rules")
	mustWrite(t, filepath.Join(dir, "AGENTS.md"), "root agents rules")
	mustWrite(t, filepath.Join(dir, ".johnnycode", "INSTRUCTIONS.md"), "legacy instructions")

	out := LoadInstructions(dir)
	for _, want := range []string{"root johnnycode rules", "root agents rules", "legacy instructions"} {
...
func TestLoadInstructionsWalksUp(t *testing.T) {
	...
	mustWrite(t, filepath.Join(root, "JOHNNYCODE.md"), "from root")
	mustWrite(t, filepath.Join(sub, "JOHNNYCODE.md"), "from leaf")
...
func TestExpandIncludesResolvesRelative(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "JOHNNYCODE.md"), "header\n@./rules/style.md\nfooter\n")
...
func TestExpandIncludesIgnoresCycles(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "JOHNNYCODE.md"), "@./a.md\n")
...
func TestExpandIncludesSkipsInsideCodeFences(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "JOHNNYCODE.md"), "```\n@./skipped.md\n```\n")
